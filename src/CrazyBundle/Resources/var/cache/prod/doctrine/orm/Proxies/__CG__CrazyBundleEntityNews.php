...
namespace Proxies\__CG__\CrazyBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class News extends \CrazyBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CrazyBundle\\Entity\\News' . "\0" . 'id', '' . "\0" . 'CrazyBundle\\Entity\\News' . "\0" . 'publication', '' . "\0" . 'CrazyBundle\\Entity\\News' . "\0" . 'titre', '' . "\0" . 'CrazyBundle\\Entity\\News' . "\0" . 'contenu'];
        }
